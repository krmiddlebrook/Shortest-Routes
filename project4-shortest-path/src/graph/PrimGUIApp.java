...
public class PrimGUIApp extends JFrame {
     ...
     */
    public PrimGUIApp(PrimsMST algo, Graph graph) {
        // Creating a window
    ...
    private class MapPanel extends JPanel {
        ...
        private PrimsMST algo; // Dijkstra's object
         ...
         * @param graph Reference to the graph
         */
        public MapPanel(PrimsMST algo, Graph graph) {
            this.algo = algo;
            this.graph = graph;
            this.setLayout(new BorderLayout());
            this.setPreferredSize(new Dimension(580, 290));
            this.setBackground(Color.lightGray);
            this.addMouseListener(new MapPanel.MyListener());

            // buttons
            buttonReset = new JButton("Reset");
            buttonReset.addActionListener(new MapPanel.ButtonListener());
            buttonQuit = new JButton("Quit");
            buttonQuit.addActionListener(new MapPanel.ButtonListener());
        ...
        class MyListener implements MouseListener {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (!oneClicked) { // first click
                    ...
                    System.out.println(
                            "Call Prim's shortestPath() method to compute the shortest path between selected cities");
                    destination = v;
